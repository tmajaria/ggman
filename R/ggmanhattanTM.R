...
ggmanhattanTM <- function(data, SNP = "SNP", chr = "CHR", bp = "BP", P = "P", group = "group_id", P_char = NULL, logP = TRUE, build = 'hg19',
  ...
  all.cols <- c("#FF0000" = "#FF0000", "#008B00" = "#008B00", "#0000FF" = "#0000FF", "#454545" = "#454545", "#EE00EE" = "#EE00EE", "#009ACD" = "#009ACD", "#EE7600" = "#EE7600","grey40" = "grey40", "grey70" = "grey70")
  ...
  plt = ggplot(data) + geom_point(data = base::subset(data, GROUP == "NA"), aes(x, y, color = color)) +
          ...
          geom_hline(yintercept = -log10(significance), linetype = "dashed", color = "blue") +
